 ...
 * - Letras Minúsculas (a-z): 97 a 122
 ...
 Desenvolva um programa para o PICSimLab/PIC16F877A de tal forma que ele ao receber um
número ou letra via serial, vindo de um monitor serial (por exemplo), apresente essa informação no
LCD da seguinte forma: na primeira linha será escrito IFMT e na segunda, se for número, escreve
Numero=X. Onde X é o número. Se for letra, escreve Letra = c, onde c é a letra.
OBS:
Considere número o valor maior ou igual a 48 (número 0) e menor ou igual a 57 (número 9)
Considere letra o valor maior ou igual a 65 (Letra A) e menor ou igual a 90 (Letra Z).
Considere letra o valor maior ou igual a 97 (Letra a) e menor ou igual a 122 (Letra z)
